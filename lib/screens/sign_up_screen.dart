...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Future<void> _continueWithGoogle() async {
    ...
    try {
      ...
      if (!mounted) return;
      Navigator.of(context).pushReplacement(slideRoute(const UsernameScreen()));
    } on FirebaseAuthException catch (e) {
      if (!mounted) return;
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Row(
                ...
                children: <Widget>[
                  _SocialButton(icon: Icons.account_circle, onTap: _submitting ? null : _continueWithGoogle),
...
class _SocialButton extends StatelessWidget {
  ...
  const _SocialButton({this.icon, this.asset, required this.onTap});

  @override
  Widget build(BuildContext context) {
    final Widget iconWidget = icon != null ? Icon(icon, size: 36, color: Colors.white) : Image.asset(asset!, height: 36, width: 36);
